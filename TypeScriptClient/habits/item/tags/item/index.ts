...
/**
 * Builds and executes requests for operations under /habits/{habit-id}/tags/{tagId}
 */
 ...
 */
export const WithTagItemRequestBuilderUriTemplate = "{+baseurl}/habits/{habit%2Did}/tags/{tagId}";
/**
